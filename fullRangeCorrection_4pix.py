...
"""
Objective： 
Full range energy spectrum correction try with 4-pixel charge sharing events
...
CS_data = pd.read_csv( 'C:\Jiajin\Mfile\Training_Sample_Analysis\Pix4_80Sharing.csv' )
...
energy_seg = np.array( [20, 50, 72, 100, 136, 145] )
energy_ind = 0
########################################################################################################
...
CF.Scatter3D_plot(ax=ax, x=Energy_E1_E2[:,0], y=Energy_E1_E2[:,1], z=Energy_E1_E2[:,3], elev=0, azim=45,\
                  color='k')
...
eps, min_samples = (2, 95) # 122 keV, high density CS events
...
seg_size = 6
CSC_36_4pix = CSC( CS_dim=CS_dim, basis_old=basis_old, basis_new=basis_new, peak_energy=36, max_energy_range=140, seg_size=seg_size )
wet_x_36, wet_y_36, wet_z_36, wet_w_36, shift_w_36, seg_unit_36 = CSC_36_4pix.Pix4_Measurement( CS_data_labeled = cluster_lab_0 )
Energy36_corrected = CSC_36_4pix.Pix4_Correction(seg_unit=seg_unit_36, shift_w=shift_w_36, CS_data_labeled=Energy_E1_E2)
...
wet_x_60, wet_y_60, wet_z_60, wet_w_60, shift_w_60, seg_unit_60 = CSC_60_4pix.Pix4_Measurement( CS_data_labeled = cluster_lab_0 )
Energy60_corrected = CSC_60_4pix.Pix4_Correction(seg_unit=seg_unit_60, shift_w=shift_w_60, CS_data_labeled=Energy_E1_E2)
...
CF.Histogram_lineplot(Hist=Energy_sum, Bins=800, x_lim_low=20, x_lim_high=150, color='blue')
########################################################################################################
...
##### Initialize the CSC object, charge sharing band correction
seg_size = 6
CSC_81_4pix = CSC( CS_dim=CS_dim, basis_old=basis_old, basis_new=basis_new, peak_energy=81, max_energy_range=140, seg_size=seg_size )
wet_x_81, wet_y_81, wet_z_81, wet_w_81, shift_w_81, seg_unit_81 = CSC_81_4pix.Pix4_Measurement( CS_data_labeled = cluster_lab_0 )
Energy81_corrected = CSC_81_4pix.Pix4_Correction(seg_unit=seg_unit_81, shift_w=shift_w_81, CS_data_labeled=Energy_E1_E2)
...
##### Initialize the CSC object, charge sharing band correction
seg_size = 6
CSC_122_4pix = CSC( CS_dim=CS_dim, basis_old=basis_old, basis_new=basis_new, peak_energy=122, max_energy_range=145, seg_size=seg_size )
wet_x_122, wet_y_122, wet_z_122, wet_w_122, shift_w_122, seg_unit_122 = CSC_122_4pix.Pix4_Measurement( CS_data_labeled = cluster_lab_0 )
Energy122_corrected = CSC_122_4pix.Pix4_Correction(seg_unit=seg_unit_122, shift_w=shift_w_122, CS_data_labeled=Energy_E1_E2)
...
##### Initialize the CSC object, charge sharing band correction
seg_size = 6
CSC_136_4pix = CSC( CS_dim=CS_dim, basis_old=basis_old, basis_new=basis_new, peak_energy=136, max_energy_range=150, seg_size=seg_size )
wet_x_136, wet_y_136, wet_z_136, wet_w_136, shift_w_136, seg_unit_136 = CSC_136_4pix.Pix4_Measurement( CS_data_labeled = cluster_lab_0 )
Energy136_corrected = CSC_136_4pix.Pix4_Correction(seg_unit=seg_unit_136, shift_w=shift_w_136, CS_data_labeled=Energy_E1_E2)
...
# check the histogram
Energy_sum = np.sum(Energy_E1_E2, axis=1).reshape(-1,1)
CF.Histogram_barplot(Hist=Energy_sum, Bins=80, x_lim_low=20, x_lim_high=150)
...
CF.Histogram_lineplot(Hist=Energy_corrected_sum, Bins=1000, x_lim_low=20, x_lim_high=145,color='red')
CF.Histogram_lineplot(Hist=Energy_sum, Bins=1000, x_lim_low=20, x_lim_high=145,color='blue')

##### save the corrected events
CF.SaveFiles(var=Energy_corrected, dim=4, var_name='d', \
              location="C:\Jiajin\Mfile\Training_Sample_Analysis\FullRangeCorrected_4pix.csv")
